...
for the LSLR model: $f(X) = \beta_0 + \beta_1 X +\epsilon$, where $Y$=WiningScore, and $X$=number of first downs.
...
$\widehat{f(X)} = 13.9609 + 0.7766 X$, where $\widehat{f(X)}$=WiningScore, $X$=number of first downs.
...
LSLR: $\widehat{Y} = 3.9496 + 1.2280 X$, where $Y$=WiningScore, $X$=number of first downs.
Third order polynomial: $\widehat{Y} = -105.625476 + 18.94921 X - 0.91915 X^2 + 0.01535 X^3$, where $Y$=WiningScore, $X$=number of first downs.
...
Y_train1 = 3.9496 + 1.2280*X_train1
```

Y_train1 = 3.9496 + 1.2280*X_train1 = 49.3856
...
The test RSS for model 1 is 1627.873, for model 2 is 	
8240.431
The test MSE for model 1 is 147.9885, for model 2 is 749.1301
...
the test RSS for model 1 is 1522.244, for model 2 is 1487.418
the test MSE for model 1 is 138.3859, for model 2 is 135.2198
